...
|---|---|---|
| 🏛️ **Arquitectura** | `@architect-agent` | 👑 `claude-opus-4-6-thinking` |
| 🛡️ **Seguridad / Review** | `@pr-reviewer-agent` | 🔬 `gemini-3.1-pro-high` |
...
| 🤖 **Automatización** | `@automation-agent` | ⚡ `gemini-3.8-flash-high` |

...
- Name: customer.spec.ts >> Flujo B2C de Compra >> Cliente EXISTENTE pasa directo al catálogo
- Location: tests/customer.spec.ts:46:7
...
- main:
  ...
  - heading "Ingresa tu WhatsApp" [level=2]
  - paragraph: Para continuar con tu pedido, necesitamos identificarte.
  - paragraph: Error de conexión. Intenta de nuevo.
  - textbox "(41) 99999-9999": "41888888888"
  - button "Continuar"
```

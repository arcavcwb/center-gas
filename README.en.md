...
|---|---|---|
| 🏛️ **Architecture** | `@architect-agent` | 👑 `claude-opus-4-6-thinking` |
| 🛡️ **Security / Review** | `@pr-reviewer-agent` | 🔬 `gemini-3.1-pro-high` |
...
| 🤖 **Automation** | `@automation-agent` | ⚡ `gemini-3.8-flash-high` |

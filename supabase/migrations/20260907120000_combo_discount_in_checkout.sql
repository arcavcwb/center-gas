-- Migración: Aplicar Descuento de Combo (BR-001) en create_b2c_order
-- Garantiza Zero-Trust: La base de datos calcula de forma determinística
-- el descuento de R$ 5,00 por cada par de Gas P13 + Agua 20L y actualiza discount_applied.
...
BEGIN
  ...
  -- 3. Crear Orden con descuento registrado contablemente
  INSERT INTO orders (
    display_id,
    customer_id,
    status,
